...
app.post('/api/assets', async (req, res) => {
    ...
    const {
        asset_tag, serial_number, model, category,
    ...
    const query = `
        INSERT INTO assets
        (asset_tag, serial_number, model, category, assigned_user, location_id, glpi_import_date)
        VALUES (?, ?, ?, ?, ?, ?, COALESCE(?, NOW()))
    `;

    const values = [
        asset_tag, serial_number || null, model || null, category,
